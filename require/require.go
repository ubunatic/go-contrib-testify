...
//	}()
//
//	condition := func(collect *require.CollectT) {
//		gotValue := externalValue.Load()
//
...
//	}
//
//	require.EventuallyWithT(t, condition 2*time.Second, 10*time.Millisecond)
...
//	}
//
//	require.EventuallyWithTf(t, condition 2*time.Second, 10*time.Millisecond, "error message %s", "formatted")
...
//	}
//
//	require.Eventuallyf(t, condition, 2*time.Second, 10*time.Millisecond, "error message %s", "formatted")
...
//	}
//	require.Never(t, condition, time.Second, 10*time.Millisecond)
...
//		return externalValue.Load()
//	}
//	require.Neverf(t, condition, time.Second, 10*time.Millisecond, "error message %s", "formatted")
...
//
//	require.Panicsf(t, func(){ GoCrazy() }, "GoCrazy must panic", "error message %s", "formatted")
